...
function AlertList () {
  function createData(check, date, measure, alertdate, alertype, alertcompo, equipnum, number, part, station, equipcompo, equipname) {
    ...
    return { check, date, measure, alertdate, alertype, alertcompo, equipnum, number, part, station, equipcompo, equipname, rowclass, spotdetail };
  }
            ...
            <TableBody>
              {rows.map((row) => (
                ...
                >
                  ...
                  <TableCell align="center"><Link to={row.spotdetail}>{row.measure}</Link></TableCell>
