...
const columns = [
  ...
  { id: 'equipname', label: '설비명', minWidth: 170 },
  { id: 'equipstate', label: '설비상태', minWidth: 170 },
  { id: 'condition', label: '상태', minWidth: 100 },
  { id: 'code', label: '고장신고/점검요청', minWidth: 100 }
];

// table data
function createData1(time, equipname, equipstate, condition) {
  let rowclass;
  let equipdetail;
  ...
  return { time, equipname, equipstate, condition, rowclass, equipdetail };
}

const rows1 = [
  createData1('2022-06-02 00:07', '좌대합실공조시-1', '송풍기 V벨트 결함', '불량'),
  createData1('2022-06-02 00:00', '좌대합실공조시-1', '송풍기 V벨트 결함', '불량'),
  createData1('2022-06-02 00:00', '좌대합실공조시-1', '송풍기 V벨트 결함', '불량'),
  createData1('2022-06-02 00:00', '좌대합실공조시-1', '송풍기 V벨트 결함', '불량'),
  createData1('2022-06-02 00:00', '좌대합실공조시-1', '송풍기 V벨트 결함', '결함'),
  createData1('2022-06-02 00:07', '좌대합실공조시-1', '송풍기 V벨트 결함', '결함'),
  createData1('2022-06-02 00:00', '좌대합실공조시-1', '송풍기 V벨트 결함', '결함'),
  createData1('2022-06-02 00:00', '좌대합실공조시-1', '송풍기 V벨트 결함', '결함'),
  createData1('2022-06-02 00:00', '좌대합실공조시-1', '송풍기 V벨트 결함', '미흡'),
  createData1('2022-06-02 00:00', '좌대합실공조시-1', '송풍기 V벨트 결함', '미흡'),
  createData1('2022-06-02 00:07', '좌대합실공조시-1', '송풍기 V벨트 결함', '미흡'),
  createData1('2022-06-02 00:00', '좌대합실공조시-1', '송풍기 V벨트 결함', '미흡'),
  createData1('2022-06-02 00:00', '좌대합실공조시-1', '송풍기 V벨트 결함', '통신'),
  createData1('2022-06-02 00:00', '좌대합실공조시-1', '송풍기 V벨트 결함', '통신'),
  createData1('2022-06-02 00:00', '좌대합실공조시-1', '송풍기 V벨트 결함', '통신'),
  createData1('2022-06-02 00:07', '좌대합실공조시-1', '송풍기 V벨트 결함', '통신'),
  createData1('2022-06-02 00:00', '좌대합실공조시-1', '송풍기 V벨트 결함', '통신'),
  createData1('2022-06-02 00:00', '좌대합실공조시-1', '송풍기 V벨트 결함', '통신'),
  createData1('2022-06-02 00:00', '좌대합실공조시-1', '송풍기 V벨트 결함', '통신'),
  createData1('2022-06-02 00:00', '좌대합실공조시-1', '송풍기 V벨트 결함', '통신')
