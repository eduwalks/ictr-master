...
// table data
function createData1(time, number, part, station, equipname, product, division, analysis) {
  return { time, number, part, station, equipname, product, division, analysis };
}

const rows1 = [
  createData1('2022-06-02 00:07', '1호선', '예술회관', '부평', '우 직팽식공조기', 'EOCR', '유지보수(교체)', '고장 및 기능장애'),
  createData1('2022-06-02 00:07', '1호선', '예술회관', '부평', '우 직팽식공조기', 'EOCR', '유지보수(교체)', '고장 및 기능장애'),
  createData1('2022-06-02 00:07', '1호선', '예술회관', '부평', '우 직팽식공조기', 'EOCR', '유지보수(교체)', '고장 및 기능장애'),
  createData1('2022-06-02 00:07', '1호선', '예술회관', '부평', '우 직팽식공조기', 'EOCR', '유지보수(교체)', '고장 및 기능장애'),
  createData1('2022-06-02 00:07', '1호선', '예술회관', '부평', '우 직팽식공조기', 'EOCR', '유지보수(교체)', '고장 및 기능장애'),
