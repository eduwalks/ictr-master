...
// table data
function createData1(time, division, number, part, station, sort, equipname, result) {
  let rowclass;
  if(result == '주의관찰') {
    rowclass='condition3';
  } else if(result == '유지보수') {
...
const rows1 = [
  createData1('2022-06-02 00:07', '상시', '1호선', '예술회관', '부평', '공기조화설비', '좌대합실공조시-1', '정상'),
  createData1('2022-06-02 00:07', '일일', '1호선', '예술회관', '부평', '소방설비', '좌대합실공조시-1', '유지보수'),
  createData1('2022-06-02 00:07', '일일', '1호선', '예술회관', '부평', '승강장안전문설비', '좌대합실공조시-1', '주의관찰'),
  createData1('2022-06-02 00:07', '상시', '1호선', '예술회관', '부평', '공기조화설비', '좌대합실공조시-1', '정상'),
  createData1('2022-06-02 00:07', '일일', '1호선', '예술회관', '부평', '소방설비', '좌대합실공조시-1', '유지보수'),
  createData1('2022-06-02 00:07', '일일', '1호선', '예술회관', '부평', '승강장안전문설비', '좌대합실공조시-1', '주의관찰'),
  createData1('2022-06-02 00:07', '상시', '1호선', '예술회관', '부평', '공기조화설비', '좌대합실공조시-1', '정상'),
